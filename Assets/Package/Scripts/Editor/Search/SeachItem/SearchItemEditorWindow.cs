...
[assembly: InternalsVisibleTo("ClusterEditorToolKit.Tests.Editor")]
...
namespace ShirayuriMeshibe.Search.SearchItem
{
    public sealed class SeachItemEditorWindow : EditorWindow
    {
        ...
        ReadOnlyCollection<SearchLogic> _searchLogics = new List<SearchLogic>()
        {
            ...
            { new SearchLogicGimmickGlobal(typeof(PlayAudioSourceGimmick)) },
            { new SearchLogicGimmickGlobal(typeof(PlayTimelineGimmick)) },
            ...
            { new SearchLogicGimmickGlobal(typeof(SetAnimatorValueGimmick)) },
            { new SearchLogicGimmickGlobal(typeof(SetFillAmountGimmick)) },
            { new SearchLogicGimmickGlobal(typeof(SetGameObjectActiveGimmick)) },
            ...
            { new SearchLogicGimmickGlobal(typeof(SetSliderValueGimmick)) },
            { new SearchLogicGimmickGlobal(typeof(SetTextGimmick)) },
            ...
            { new SearchLogicGimmickGlobal(typeof(StopTimelineGimmick)) },
